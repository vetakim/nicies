...
c.BaseIPythonApplication.profile = 'zenburn'
...
c.InteractiveShell.banner2 = 'ВЕРСИИ МОГУТ БЫТЬ НЕ ТЕ! ОНИ ТУТ ГВОЗДЯМИ ЗАБИТЫ, АТЕНШН!\n'
...
c.InteractiveShellApp.exec_lines = [
        'import numpy as np',
        'from matplotlib.pyplot import plot, show, xlabel, ylabel, xlim, ylim, grid, xscale, yscale, title, text',
...
#  paraiso-dark, lovelace, algol, algol_nu, arduino, rainbow_dash, abap
...
c.TerminalInteractiveShell.highlighting_style_overrides = {
        Token.Prompt: '#00fa00 bold',
        Token.PromptNum: '#00ce00',
        Token.OutPrompt: '#00baba',
        Token.OutPromptNum: '#ff9640',
        }
...
c.TerminalInteractiveShell.space_for_menu = 16
...
c.HistoryAccessor.hist_file = '/tmp/ipython_zenburn_hist.sqlite'
